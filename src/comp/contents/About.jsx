...
const school ={
    title: "학력",
    contents :(
        `<h4>2015~2018 광남고등학교 졸업</h4>
        <h4>2021~2025 가천대학교 졸업</h4>
...
const certificate = {
    title:"자격증",
    contents:(
        `<h4>2021 - SQLD,컴퓨터활용능력1급</h4>
        <h4>2022 - 토익 900점, 한국사 1급</h4>
        <h4>2023 - 게임 프로그래밍전문가 자격증,리눅스마스터1급</h4>
        <h4>2024 - 게임 기획전문가 자격증</h4>
        <h4>2025 - 정보처리기사</h4>`
    )
}
const competition = {
    title:"대회 수상 경력",
    contents:(
        `<h4>2022 - 메타버스 개발자 경진대회 장려상</h4>
        <h4>2023 - 가천대학교 프로그래밍 경진대회 은상</h4>
        <h4>2024 - 교내 졸업프로젝트 대상</h4>
        <h4> 2025 - 이브아이 게임톤 대상</h4>`
    )
}
