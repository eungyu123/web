...
`
// const data = [
//   { project: 'Gitgub', database: 'MYSQL', frontend: 'HTML/CSS', backend: 'Node.js', language: 'Python', devTool: 'VS CODE' },
//   { project: '', database: 'ORACLE', frontend: '', backend: '', language: 'C#', devTool: 'UNITY' },
//   { project: '', database: 'React', frontend: '', backend: '', language: 'C++', devTool: '' },
//   { project: '', database: '', frontend: '', backend: '', language: 'JAVA', devTool: '' },
// ];
